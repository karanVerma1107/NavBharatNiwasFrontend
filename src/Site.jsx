...
const boldTextInsideQuotes = (text) => {
  ...
  const processedText = text.replace(regex, (match, p1) => {
    // Wrap text inside quotes in a <span> with a bold class
    return `<span class="bold-text">${p1}</span>`;
  });
    ...
    <div className="site-container">
        ...
        <p 
              ...
              dangerouslySetInnerHTML={{
                __html: boldTextInsideQuotes(site.description) // Applying bold to text inside quotes
              }} 
            />
        </div>
